...
public class CompletedToDoAdapter extends RecyclerView.Adapter<ToDoViewHolder> {
    @Override
    ...
    public void onBindViewHolder(ToDoViewHolder holder, int position) {
        holder.bind(ToDoResponseBody.completedToDoList.get(position));
    }

    @Override
    public int getItemCount() {
        return ToDoResponseBody.completedToDoList.size();
    }
}
